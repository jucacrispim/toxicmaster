...
from toxiccore import utils, build_config
from toxiccore.utils import string2datetime
from .build import (BuildSet, Builder, BuildManager)
from .client import get_poller_client, get_secrets_client
...
class Repository(OwnedDocument, utils.LoggerMixin):
    ...
    """A list of :class:`~toxicmaster.repository.RepositoryBranch`.
    ...
    """A list of :class:`~toxicmaster.slave.Slave`. The slaves here
    ...
    def get_branch(self, branch_name):
        ...
        :class:`~toxicmaster.repository.RepositoryBranch`"""
    ...
    def get_config_for(self, revision):
        ...
        :param revision: A
          :class`~toxicmaster.repository.RepositoryRevision` instance.
        """
...
class RepositoryRevision(Document):
    ...
    """A list of :class:`~toxicmaster.bulid.RepositoryRevisionExternal`.
    """
