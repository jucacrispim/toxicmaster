...
from toxiccore.exceptions import ToxicClientException, BadJsonData
from toxiccore.utils import (string2datetime, LoggerMixin)
from toxiccommon.coordination import Lock
...
class Slave(OwnedDocument, LoggerMixin):
    ...
    the network (using :class:`toxicmaster.client.BuildClient`).
    """
    ...
    async def build(self, build, **envvars):
        ...
        :param build: An instance of :class:`toxicmaster.build.Build`
    ...
    async def _get_step(self, build, step_uuid, wait=False):
        ...
        :param build: A :class:`toxicmaster.build.Build` instance.
